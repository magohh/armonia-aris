...
<hr />
   ...
   <div class="ahb-statssection-container" style="background:#f6f6f6;">
	...
	<div class="ahb-statssection">
        ...
        <div class="ahb-csssample">
         <div class="ahb-csssampleheader">
           Move additional services field below the calendar (before the form fields):
         </div>
         <div class="ahb-csssamplecode">
           <pre> jQuery(document).one('showHideDepEvent', function(){
    (function($) {
        $( "#fbuilder" ).before($("#abcservices"));                      
    })(jQuery); 
});</pre>
         </div>
        </div> 
