 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
   ...
   <script>
    ...
    initAppCalendar("cal<?php echo CP_CALENDAR_ID; ?>","3","1","<?php echo CPABC_TDEAPP_DEFAULT_CALENDAR_LANGUAGE; ?>",{m1:"Please, select your appointment."});
   </script>
   ...
   <table class="form-table">
        ...
        <td>
             ...
             <select name="calendar_language">        
               ...
               <option value="FI" <?php if ($value == 'FI') echo ' selected="selected"'; ?>>Finnish</option>
          ...
          <tr>            
            <td>           
                 ...
                 <select name="calendar_dateformat" class="flenfield">               
                   ...
                   <option value="3" <?php if ($value == '3') echo ' selected="selected"'; ?>>Complete #1: Ex: Saturday 9th January</option>  
                   <option value="4" <?php if ($value == '4') echo ' selected="selected"'; ?>>Complete #2: Ex: Saturday 9th January, 2016</option>                
                   <option value="5" <?php if ($value == '5') echo ' selected="selected"'; ?>>yyyy-mm-dd</option>                   
                 </select>           
            </td>
            <td>           
             Calendar Pages:<br />
           ...
           <tr>
            <td nowrap valign="top">
             ...
             <em style="font-size:11px;">Examples:<br /> 2014-01-25, today, today +3 days, now +30 hours</em>
            </td>   
            <td nowrap valign="top">
...
<?php } ?>        
        ...
        <tr valign="top">
        <th scope="row">PayPal Tax</th>
        <td><input type="text" name="paypal_tax" value="<?php echo esc_attr(cpabc_get_option('paypal_tax','0')); ?>" />
<br /> <em> * Example: Enter 10 for a 10% tax.</em>
</td>
        </tr>          
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">    
        ...
        <td><input type="email" required name="notification_from_email" size="40" value="<?php echo esc_attr(cpabc_get_option('notification_from_email', _cpabc_appointments_get_default_from_email() )); ?>" /></td>
        </tr>             
        <tr valign="top">
        ...
        <td><input type="text" name="email_subject_notification_to_admin" size="70" value="<?php echo esc_attr(cpabc_get_option('email_subject_notification_to_admin', CPABC_APPOINTMENTS_DEFAULT_SUBJECT_NOTIFICATION_EMAIL)); ?>" /><br />
        <em>Please enter in this field whatever message you need in order to identify where the notification is coming from. Especially if you have multiple forms on the same website this field will help you distinguish the form it is coming from.</em></td>
        </tr>
        <tr valign="top">
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">  
     ...
     <table class="form-table" id="cpabc_remindertable">            
        ...
        <br /><em>Note: Hours date based in MySQL server time. MySQL database server time is <strong><?php $stime = $wpdb->get_results("SELECT NOW() as tm;"); echo $stime[0]->tm;?></strong></em>
        </td>
        </tr>
        <tr valign="top">
