...
function armonia_scripts() {
	wp_enqueue_style( 'armonia-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'armonia-style', 'rtl', 'replace' );

	// wp_enqueue_script( 'armonia-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
